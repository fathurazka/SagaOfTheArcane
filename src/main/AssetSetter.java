...
public class AssetSetter {
	...
	public void setEnemy() {
		if (player.level == 3) {
			...
			gp.enemy[13].worldX = 35 * gp.tileSize;
			gp.enemy[13].worldY = 36 * gp.tileSize;
			gp.enemy[13].type = 1;
		...
		if (player.level == 1) {
			...
			gp.enemy[0] = new Skeleton(gp);
			gp.enemy[0].worldX = 8 * gp.tileSize;
			gp.enemy[0].worldY = 12 * gp.tileSize;
			gp.enemy[0].type = 1;
			...
			gp.enemy[8].worldX = 32 * gp.tileSize;
			gp.enemy[8].worldY = 38 * gp.tileSize;
			gp.enemy[8].type = 1;
		...
		if (player.level == 4) {
			...
			gp.enemy[21] = new Giant(gp);
			gp.enemy[21].worldX = 35 * gp.tileSize;
			gp.enemy[21].worldY = 40 * gp.tileSize;
			gp.enemy[21].type = 1;
		...
		if (player.level == 7) {
			...
			gp.enemy[22] = new Dragon(gp);
			gp.enemy[22].worldX = 17 * gp.tileSize;
			gp.enemy[22].worldY = 38 * gp.tileSize;
			gp.enemy[22].type = 1;
